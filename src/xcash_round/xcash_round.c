...
xcash_round_result_t process_round(void) {
  ...
  INFO_PRINT_STATUS_OK("Consensus reached: Delegate: %s Votes: %d (required %d)", 
    current_block_verifiers_list.block_verifiers_name[max_index], max_votes, agreement_needed);
